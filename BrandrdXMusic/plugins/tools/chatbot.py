...
@app.on_message(
        filters.command(["chatbot off", f"chatbot@{app.mention} off"], prefixes=["/", ".", "?", "-"])
        & ~filters.private)
...
@app.on_message(
    filters.command(["chatbot on", f"chatbot@{app.mention} on"] ,prefixes=["/", ".", "?", "-"])
    & ~filters.private)
...
@app.on_message(
    filters.command(["chatbot", f"chatbot@{app.mention}"], prefixes=["/", ".", "?", "-"])
    & ~filters.private)
